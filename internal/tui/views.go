...
func (m Model) helpView() string {
	...
	b.WriteString("  L           Tail selected/top job logs; press `L` or `esc` to return\n")
	...
	b.WriteString("  Shift+O     Options overlay (theme, refresh, density, sorting)\n")
	b.WriteString("  d           Open artifact download picker\n")
